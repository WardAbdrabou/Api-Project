...
const isImageExist = (myResNameFile) =>
...
const isImageDirectory = (imageDirectoryName) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const imageResize = (myNameinpFile, width, height, myNameOutFile) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const imageNameoutExist = yield isImageExist(myNameOutFile);
    if (!imageNameoutExist) {
      console.log("File image is been created");
      yield (0, sharp_1.default)("../../all/images/fjord.jpg")
        .resize(width, height)
        .toFile(myNameOutFile);
